   ...
   <div class="col-lg-6 col-md-12">
      <div class="form-group">
         ...
         <div class="field-group-inner">
            <select class="custom-select custom-good-select input" name="category" id="ptl-category" multiple="multiple">
               <?php
      ...
      <div class="form-group">
         ...
         <div class="field-group-inner">
            <select name="sort-by" class="custom-select custom-good-select input" id="ptl-sort-by">
               ...
               <option value="ptl-post-date"><?php echo esc_attr__('PTL Date', 'post-timeline') ?></option>

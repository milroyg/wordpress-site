...
/**
 * PostTimeline autoloader.
 *
 * PostTimeline autoloader handler class is responsible for loading the different
...
class Autoloader {
	 ...
	 * Classes map.
	 *
	 * Maps PostTimeline classes to file names.
	 *
	 * @since 4.7.22
	 * @access private
	 * @static
	 *
	 * @var array Classes used by PostTimeline.
	 */
	 ...
	 * Classes aliases.
	 *
	 * Maps PostTimeline classes to aliases.
	 *
	 * @since 4.7.22
	 * @access private
	 * @static
	...
	public static function run($_path = '', $_namespace = '' ) {
		...
		self::$default_path 			= ($_path)? $_path: POST_TIMELINE_PLUGIN_PATH;
	...
	private static function autoload( $class ) {
		...
		/*if(!in_array($class, ['PostTimeline\Loader', 'PostTimeline\i18n'])) {
		}*/

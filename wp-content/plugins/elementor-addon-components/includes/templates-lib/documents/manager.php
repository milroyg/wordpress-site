...
final class Manager {
	...
	public function includes() {
		require_once __DIR__ . '/siteheader.php';
		require_once __DIR__ . '/sitefooter.php';
	...
	public function enqueue_scripts() {
		...
		if ( Eac_Config_Elements::is_widget_active( 'mega-menu' ) ) {
			EAC_Plugin::instance()->register_script( 'eac-mega-menu', 'includes/templates-lib/assets/js/mega-menu', array( 'jquery', 'elementor-frontend' ), EAC_PLUGIN_VERSION,
				array(
					'strategy' => 'defer',
					'in_footer' => true,
				)
